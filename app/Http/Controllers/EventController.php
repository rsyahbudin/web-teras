...
class EventController extends Controller
{
    public function index()
    {
        ...
        return view('legacy-garden', [
            ...
            'feature_1_title' => $content['legacy_feature_1_title'] ?? 'Capacity',
            'feature_1_text' => $content['legacy_feature_1_text'] ?? 'Comfortably hosts up to 300 guests standing or 150 seated guests.',
            'feature_2_title' => $content['legacy_feature_2_title'] ?? 'Ample Parking',
            'feature_2_text' => $content['legacy_feature_2_text'] ?? 'Dedicated parking area for up to 80 cars with valet service available.',
            'feature_3_title' => $content['legacy_feature_3_title'] ?? 'Bridal Suite',
            'feature_3_text' => $content['legacy_feature_3_text'] ?? 'Private, air-conditioned preparation room for the bride and family.',
            'feature_4_title' => $content['legacy_feature_4_title'] ?? 'In-House Catering',
            'feature_4_text' => $content['legacy_feature_4_text'] ?? 'Authentic Indonesian & International buffet menus from our kitchen.',
