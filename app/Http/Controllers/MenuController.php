...
class MenuController extends Controller
{
    public function index()
    {
        ...
        return view('menu', [
            ...
            'hero_badge' => $content['menu_hero_badge'] ?? 'Since 1985',
            'hero_description' => $content['menu_hero_description'] ?? 'Experience traditional recipes passed down through generations, served in our comforting botanical garden terrace.',
