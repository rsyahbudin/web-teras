...
class Index extends Component
{
    ...
    public $sections = [
        'home_hero' => [
            ...
            'fields' => [
                ['key' => 'home_hero_greeting', 'label' => 'Greeting Text', 'type' => 'text'], // e.g., Welcome to
                ['key' => 'home_hero_brand', 'label' => 'Brand Name', 'type' => 'text'], // e.g., Teras Rumah Nenek
        ...
        'legacy_garden_hero' => [
            ...
            'fields' => [
                ['key' => 'legacy_hero_title', 'label' => 'Main Title', 'type' => 'text'], // "Where Love Blooms"
                ['key' => 'legacy_hero_subtitle', 'label' => 'Highlight Word', 'type' => 'text'], // "Naturally" (Green text)
        ...
        'legacy_garden_intro' => [
            ...
            'fields' => [
                ...
                ['key' => 'legacy_intro_title', 'label' => 'Main Heading', 'type' => 'text'], // "A Rustic Sanctuary..."
    ...
    public function saveSection()
    {
        ...
        // Optional: Flash message logic here
