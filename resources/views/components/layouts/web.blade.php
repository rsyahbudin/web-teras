...
<body class="bg-white text-wood-dark font-sans antialiased min-h-screen flex flex-col selection:bg-accent-green selection:text-white">
    ...
    <!-- Navigation -->
    <header class="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-md border-b border-wood/10 shadow-sm transition-all duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        @if(!empty($global_contact['social_instagram']))
                        <a href="{{ $global_contact['social_instagram'] }}" target="_blank" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors text-white">
                        ...
                        @endif
                        @if(!empty($global_contact['social_tiktok']))
                        <a href="{{ $global_contact['social_tiktok'] }}" target="_blank" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors text-white">
